...
module.exports = class Role {
  ...
  async _loadLatestScvState() {
    ...
    this.logger.log('info','','load latest state', 'successful!!');
    this.myStateVersion = this.stateVersion;
    await this.etcdClient.put(this.myStateVersionKey).value(this.myStateVersion);
  }
